...
export enum AnalyticsAction {
  ...
  IN_BROWSER_COMPILE_ERROR = "IN_BROWSER_COMPILE_ERROR",
  IN_BROWSER_COMPILE_START = "IN_BROWSER_COMPILE_START",
  IN_BROWSER_COMPILE_SUCCESS = "IN_BROWSER_COMPILE_SUCCESS",
  GETTER_PARSE_START = "GETTER_PARSE_START",
  RUN_GETTER = "RUN_GETTER",
}
